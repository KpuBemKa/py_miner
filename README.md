...
4. Расположить персонажа:  
    a. Два блока поверх первого блока слоя. Убедиться, что игрок находится на той половине блока, где по мере движения он не сможет врезаться в боковую стену. Если, например 
      боковая стена находится справа, необходимо разместить игрока не левой половине блока.    
